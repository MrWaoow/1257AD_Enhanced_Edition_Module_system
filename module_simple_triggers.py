...
simple_triggers = [
  ...
  [
      ...
      (try_begin),
        ...
        (try_begin),
          ...
          (else_try),
            ...
            (eq, ":var5", 5),
            (call_script, "script_cf_troop_change_relation_with_troop", ":var0", ":var4", -4),
          ...
          (else_try),
            ...
            (eq, "$g_no_money_for_compensation", 1),
            (eq, ":var5", 1),
            (call_script, "script_cf_troop_change_relation_with_troop", ":var0", ":var4", -2),
    ...
    (try_begin),
      ...
      (try_begin),
        ...
        (try_begin),
          ...
          (call_script, "script_cf_change_troop_faction", ":var0", ":var20"),
          (try_begin),
            (ge, "$cheat_mode", 1),
    ...
    (try_for_range, ":var25", "trp_npc1", "trp_knight_1_1_wife"),
      ...
      (lt, ":var28", ":var27"),
      (call_script, "script_cf_troop_change_relation_with_troop", ":var0", ":var25", 1),
  ...
  [
    ...
    (try_begin),
      ...
      (try_begin),
        ...
        (call_script, "script_cf_recalculate_ais_for_faction", "$g_recalculate_ais_cur_fac"),
      (else_try),
  ...
  [
    ...
    (try_end),
    (call_script, "script_cf_food_consumption_display_message", ":var4"),
    (call_script, "script_get_player_party_morale_values"),
    (assign, ":var10", reg1),
  ...
  [
    (try_for_range, ":var0", "trp_npc1", "trp_knight_1_1_wife"),
      ...
      (else_try),
        (call_script, "script_cf_change_troop_faction", ":var0", ":var2"),
    ...
    (try_begin),
      ...
      (try_for_range, ":var1", "trp_npc1", "trp_knight_1_1_wife"),
        ...
        (try_begin),
          ...
          (call_script, "script_cf_change_troop_faction", ":var1", ":var2"),
          (try_for_range, ":var1", "trp_npc1", "trp_knight_1_1_wife"),
            (troop_slot_eq, ":var1", 2, 2),
  ...
  [
    ...
    (try_begin),
      ...
      (try_begin),
        ...
        (try_begin),
          (lt, reg0, 35),
          (call_script, "script_cf_kill_lord_assassination", "$g_assassination_attempt_cur_npc", 1, ":var0"),
        (else_try),
          (call_script, "script_cf_kill_lord_assassination", "$g_assassination_attempt_cur_npc", 0, 0),
        (try_end),
      (else_try),
        ...
        (try_begin),
          ...
          (call_script, "script_cf_kill_lord_assassination", "$g_assassination_attempt_cur_npc", 1, ":var0"),
        (else_try),
          (call_script, "script_cf_kill_lord_assassination", "$g_assassination_attempt_cur_npc", 0, -1),
        (try_end),
      (try_end),
    (try_end),
  ...
  [
    (try_begin),
      ...
      (try_begin),
        ...
        (try_begin),
          (lt, reg0, 35),
          (call_script, "script_cf_kill_lord_assassination", "$lord_to_assassinate", 1, "trp_player"),
          (call_script, "script_add_notification_menu", "mnu_lord_assassination_by_player_suceeded", "$lord_to_assassinate"),
        (else_try),
          (call_script, "script_cf_kill_lord_assassination", "$lord_to_assassinate", 0, "trp_player"),
          (call_script, "script_add_notification_menu", "mnu_lord_assassination_by_player_suceeded", "$lord_to_assassinate"),
        (try_end),
      (else_try),
  ...
  [
    ...
    (try_begin),
      ...
      (try_begin),
        ...
        (call_script, "script_cf_initiate_civil_war", "$g_misc_civil_war_cur_faction", ":var1"),
      (try_end),
  ...
  [
    ...
    (try_begin),
      ...
      (else_try),
        (call_script, "script_cf_change_troop_faction", "$g_leave_defeated_faction_cur_lord", ":var1"),
