...
skills = [
  ...
  ("foraging", "Foraging", sf_base_att_int|sf_effects_party, 10, "Allows the party to forage for 5 food per skill level (camp, siege, raiding) and increase foraging range (Party skill) Max level: 10."),
  ("looting", "Looting", sf_base_att_int|sf_effects_party, 10, "This skill increases the amount of loot obtained by 10%% per skill level. (Party skill)"),
