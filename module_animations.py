...
animations = [
  ...
  ["stand_single", 0, amf_client_prediction,
    [9, "sword_loop01", 0, 200, arf_cyclic|arf_use_stand_progress, 0, (0, 0, 0), 0.25],
  ],
  ...
  ["walk_forward_crouch", acf_anim_length(100)|acf_parallels_for_look_slope, 0,
    [10, "low_walk", 1, 81, arf_blend_in_3|arf_make_walk_sound|arf_cyclic|arf_use_walk_progress, pack2f(0.9, 0.4), (0, 0, 0), 0],
  ],
  ["stand_to_crouch", acf_enforce_lowerbody|acf_parallels_for_look_slope, 0,
    [5, "crouch_down", 1, 81, arf_cyclic, pack2f(0.9, 0.4), (0, 0, 0), 0],
  ],
  ["crouch_to_stand", acf_enforce_lowerbody, 0,
    [1.7, "crouch_down", 154, 185, arf_blend_in_1],
  ],
  ...
  ["ready_bow", acf_anim_length(100)|acf_rot_vertical_bow, amf_priority_attack|amf_rider_rot_bow|amf_use_weapon_speed|amf_keep|amf_client_owner_prediction,
    [1.5, "anim_archery", 16, 133, arf_blend_in_6|arf_make_custom_sound, pack2f(0.44, 0.14), (0, 0, 0), 0],
  ],
  ...
  ["ready_swingright_fist", 0, amf_priority_attack|amf_rider_rot_swing_right|amf_use_weapon_speed|amf_keep|amf_client_owner_prediction,
    [0.35, "right_swing", 0, 15, arf_blend_in_6],
  ],
  ["release_swingright_fist", 0, amf_priority_attack|amf_rider_rot_swing_right|amf_use_weapon_speed|amf_play,
  ...
  ["ready_swingleft_fist", 0, amf_priority_attack|amf_rider_rot_swing_left|amf_use_weapon_speed|amf_keep|amf_client_owner_prediction,
    [0.35, "anim_human", 24300, 24300, arf_blend_in_6],
  ],
  ["release_swingleft_fist", 0, amf_priority_attack|amf_rider_rot_swing_left|amf_use_weapon_speed|amf_play,
  ...
  ["ready_direct_fist", 0, amf_priority_attack|amf_rider_rot_thrust|amf_use_weapon_speed|amf_keep|amf_client_owner_prediction,
    [0.35, "direct_fist", 0, 16, arf_blend_in_6],
  ],
  ["release_direct_fist", 0, amf_priority_attack|amf_rider_rot_thrust|amf_use_weapon_speed|amf_play,
  ...
  ["ready_uppercut_fist", 0, amf_priority_attack|amf_rider_rot_thrust|amf_use_weapon_speed|amf_keep|amf_client_owner_prediction,
    [0.35, "uppercut", 0, 17, arf_blend_in_6],
  ],
  ["release_uppercut_fist", 0, amf_priority_attack|amf_rider_rot_thrust|amf_use_weapon_speed|amf_play,
  ...
  ["release_thrust_staff_continue", acf_anim_length(100)|acf_thrust|acf_rot_vertical_bow, amf_priority_attack|amf_use_weapon_speed|amf_play|amf_client_owner_prediction,
    [0.45, "attacks_staff_thrust", 40, 58, arf_blend_in_5],
  ],
  ...
  ["defend_fist", 0, amf_priority_defend|amf_rider_rot_defend|amf_use_defend_speed|amf_play|amf_keep|amf_restart|amf_client_owner_prediction,
    [0.75, "anim_human", 24950, 24960, arf_blend_in_3],
  ],
  ["defend_fist_keep", 0, amf_priority_defend|amf_rider_rot_defend|amf_keep|amf_client_owner_prediction,
  ...
  ["defend_shield_keep", acf_anim_length(100)|acf_parallels_for_look_slope, amf_priority_defend|amf_rider_rot_defend|amf_keep|amf_client_owner_prediction,
    [2, "shield3", 6, 6, arf_blend_in_4|arf_cyclic],
  ],
  ...
  ["fall_chest_front", acf_align_with_ground|acf_enforce_all|acf_lock_camera, amf_priority_die|amf_accurate_body|amf_client_prediction|amf_keep,
    ...
    [2.1, "new_death_3", 0, 45, arf_blend_in_16|arf_make_custom_sound, pack2f(0.9, 0), (0, 0, 0), 1.6],
  ],
  ["fall_abdomen_hold_front", acf_align_with_ground|acf_enforce_all|acf_lock_camera, amf_priority_die|amf_accurate_body|amf_client_prediction|amf_keep,
    ...
    [2.5, "new_death_7", 0, 194, arf_blend_in_16|arf_make_custom_sound, pack2f(0.4, 0), (0, 0, 0), 2.35],
  ],
  ...
  ["fall_body_back", acf_align_with_ground|acf_enforce_all|acf_lock_camera, amf_priority_die|amf_accurate_body|amf_client_prediction|amf_keep,
    ...
    [2.2, "new_death_crawl", 0, 109, arf_blend_in_10|arf_make_custom_sound, pack2f(0.47, 0.82), (0, 0, 0), 2.19],
  ],
  ["fall_rider_right_forward", acf_enforce_all|acf_lock_camera, amf_priority_die|amf_accurate_body|amf_client_prediction|amf_keep,
    [2.2, "anim_human", 40200, 40275, arf_blend_in_3|arf_make_custom_sound, pack2f(0.8, 0), (0, 0, 0), 0.3],
    [2.2, "fall_rider_right_forward", 0, 68, arf_blend_in_3|arf_make_custom_sound, pack2f(0.8, 0), (0, 0, 0), 0.3],
  ],
  ["fall_rider_right", acf_enforce_all|acf_lock_camera, amf_priority_die|amf_accurate_body|amf_client_prediction|amf_keep,
    [2.2, "anim_human", 40200, 40275, arf_blend_in_3|arf_make_custom_sound, pack2f(0.8, 0), (0, 0, 0), 0.3],
    [1.9, "fall_rider_right", 0, 57, arf_blend_in_3|arf_make_custom_sound, pack2f(0.8, 0), (0, 0, 0), 0.3],
  ],
  ["fall_rider_left", acf_enforce_all|acf_lock_camera, amf_priority_die|amf_accurate_body|amf_client_prediction|amf_keep,
    [2.2, "anim_human", 40200, 40275, arf_blend_in_3|arf_make_custom_sound, pack2f(0.8, 0), (0, 0, 0), 0.3],
    [1.9, "fall_rider_left", 0, 56, arf_blend_in_3|arf_make_custom_sound, pack2f(0.8, 0), (0, 0, 0), 0.3],
  ],
  ...
  ["reload_musket_full", 0, amf_priority_reload|amf_use_weapon_speed|amf_play,
    [2.5, "man_reload", 0, 340, arf_blend_in_3|arf_stick_item_to_left_hand],
  ],
  ["reload_musket_two_third", 0, amf_priority_reload|amf_use_weapon_speed|amf_play,
    [1.7, "man_reload", 110, 340, arf_blend_in_3|arf_stick_item_to_left_hand],
  ],
  ["reload_musket_one_third", 0, amf_priority_reload|amf_use_weapon_speed|amf_play,
    [0.6, "man_reload", 270, 340, arf_blend_in_3|arf_stick_item_to_left_hand],
  ],
  ...
  ["ready_overswing_spear", acf_anim_length(100)|acf_overswing|acf_rot_vertical_bow, amf_priority_attack|amf_use_weapon_speed|amf_keep|amf_client_owner_prediction|amf_use_inertia,
    [0.35, "attacks_staff_thrust_overhead", 6, 21, arf_blend_in_6],
  ],
  ["release_overswing_spear", acf_anim_length(100)|acf_overswing|acf_rot_vertical_bow, amf_priority_attack|amf_use_weapon_speed|amf_play|amf_continue_to_next,
  ...
  ["ready_overswing_musket", acf_overswing|acf_rot_vertical_sword, amf_priority_attack|amf_rider_rot_thrust|amf_use_weapon_speed|amf_keep|amf_client_owner_prediction|amf_use_inertia,
    [0.35, "1h_spear_thrust_overhead", 0, 20, arf_blend_in_6],
  ],
  ["release_overswing_musket", acf_overswing|acf_rot_vertical_sword, amf_priority_attack|amf_rider_rot_thrust|amf_use_weapon_speed|amf_play|amf_continue_to_next,
    [0.45, "1h_spear_thrust_overhead", 20, 41, arf_blend_in_5],
  ],
  ["release_overswing_musket_continue", 0, amf_priority_continue|amf_rider_rot_thrust|amf_use_weapon_speed|amf_play|amf_client_owner_prediction,
  ...
  ["parried_overswing_musket", 0, amf_priority_defend_parry|amf_use_weapon_speed|amf_play,
    [0.3, "1h_spear_thrust_overhead", 26, 22, arf_blend_in_5],
  ],
  ["blocked_overswing_musket", 0, amf_priority_defend_parry|amf_use_weapon_speed|amf_play,
    [0.3, "1h_spear_thrust_overhead", 26, 22, arf_blend_in_5],
  ],
  ["ready_thrust_musket", acf_overswing, amf_priority_attack|amf_use_weapon_speed|amf_keep|amf_client_owner_prediction|amf_use_inertia,
    [0.35, "musket_thrust_forward", 1, 19, arf_blend_in_6],
  ],
  ["release_thrust_musket", acf_overswing, amf_priority_attack|amf_use_weapon_speed|amf_play|amf_continue_to_next,
    [0.9, "musket_thrust_forward", 19, 50, arf_blend_in_5],
  ],
  ...
  ["parried_thrust_musket", 0, amf_priority_defend_parry|amf_use_weapon_speed|amf_play,
    [0.6, "musket_thrust_forward_parry", 1, 9, arf_blend_in_2],
  ],
  ["blocked_thrust_musket", 0, amf_priority_defend_parry|amf_use_weapon_speed|amf_play,
    [0.3, "musket_thrust_forward_parry", 1, 9, arf_blend_in_2],
  ],
  ...
  ["shield_strike", acf_align_with_ground|acf_enforce_all, amf_priority_striked|amf_accurate_body|amf_play|amf_restart,
    [1, "anim_human", 45000, 45010, arf_blend_in_3|arf_make_custom_sound],
  ...
  ["spearwall_hold", acf_align_with_ground|acf_enforce_all|acf_thrust, amf_priority_striked|amf_accurate_body|amf_play|amf_restart,
    [4, "anim_human", 27310, 27310, arf_blend_in_6],
  ],
  ["sit_drink", acf_enforce_all, amf_accurate_body,
    [3, "sit_drink", 0, 2, arf_cyclic, 0, (0, 0, 0), 0.25],
  ],
