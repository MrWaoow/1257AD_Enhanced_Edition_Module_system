...
ground_specs = [
  ("gray_stone", gtf_has_color, "stone_a", 4, "none", (0.7, 0.7, 0.7)),
  ...
  ("village", gtf_overlay|gtf_has_color, "ground_village", 7, "none", (1, 0.9, 0.59)),
  ("path", gtf_overlay|gtf_dusty|gtf_has_color, "ground_path", 6, "none", (0.93, 0.68, 0.34)),
]
